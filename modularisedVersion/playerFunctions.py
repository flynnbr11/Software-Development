...
def getPlayerInput(): 
  """
  During the users turn, asks them to input a choice of action. 
  """
  ...
  while invalidInput == 1:
    ...
    if ( act == 'P' or act == 'p' or act == 'B' or act == 'b' or act == 'A' or act == 'a' or act == 'E' or act == 'e' or act == 'q' or act == 'Q' or act.isdigit() ):
        invalidInput = 0 
    else:
